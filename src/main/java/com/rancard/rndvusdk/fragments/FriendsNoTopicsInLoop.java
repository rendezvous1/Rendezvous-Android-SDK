 ...
 */
public class FriendsNoTopicsInLoop extends Fragment{
...
//            System.out.println("Selected "+friendRequest.toString());
        }
    ...
    private void getFriends(){
        ...
        mRendezvousSDK.getFriends(Rendezvous.msisdn, 1, Rendezvous.STOREID, 5, true, "eq0", Rendezvous.CLIENT_ID, new RendezvousRequestListener() {
            @Override
